package com.richfit.barcodesystemproduct.module_location_process.location_qt.header.imp;
...
import com.richfit.barcodesystemproduct.module_location_process.location_qt.header.ILocQTHeaderPresenter;
import com.richfit.barcodesystemproduct.module_location_process.location_qt.header.ILocQTHeaderView;
...
public class LocQTHeaderPresenterImp extends BaseHeaderPresenterImp<ILocQTHeaderView>
        implements ILocQTHeaderPresenter {

    ILocQTHeaderView mView;

    @Inject
    public LocQTHeaderPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
