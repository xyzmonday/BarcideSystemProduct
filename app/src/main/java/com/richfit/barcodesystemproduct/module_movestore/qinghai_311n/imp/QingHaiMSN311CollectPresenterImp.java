...
import com.richfit.barcodesystemproduct.barcodesystem_sdk.ms.base_msn_collect.imp.NMSCollectPresenterImp;
...
public class QingHaiMSN311CollectPresenterImp extends NMSCollectPresenterImp{

    @Inject
    public QingHaiMSN311CollectPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
