package com.richfit.barcidesystemproduct.test;
...
public class ISODialogTestActivity extends AppCompatActivity implements OnItemClickListener, OnDismissListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iso_dialog_test);
        ...
        ViewGroup extView = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.iso_alert_form, null);
